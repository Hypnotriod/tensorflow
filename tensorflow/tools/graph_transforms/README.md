...
[tensorflow/python/tools/freeze_graph.py](https://github.com/galeone/tensorflow/blob/master/tensorflow/python/tools/freeze_graph.py)
...
unsure, the
[`summarize_graph`](https://github.com/galeone/tensorflow/blob/master/tensorflow/tools/graph_transforms/summarize_graph_main.cc)
...
[tensorflow/core/kernels/BUILD:android_extended_ops](https://github.com/galeone/tensorflow/blob/master/tensorflow/core/kernels/BUILD)
...
if you're in doubt check with the model's author, or use the [`summarize_graph`](https://github.com/galeone/tensorflow/tree/master/tensorflow/tools/graph_transforms#inspecting-graphs) tool
...
[tensorflow/tools/graph_transforms/rename_op.cc](https://github.com/galeone/tensorflow/tree/master/tensorflow/tools/graph_transforms/rename_op.cc),
